...
public class PaintingWalls {
    ...
    public static boolean ok( int r, int c, int rowSize, int colSize ){
        return ( r > 0 && c > 0 && r < rowSize + 3 && c < colSize + 3);
    }
    ...
    public static void isOkayToPaint( ){
        ...
        for(int i = 1; i < rowSize + 2; i++){  //row i of maze
            for(int j = 1 ; j < colSize + 2; j++){  //col j of maze
                if(ok(nbr.row,nbr.col,rowSize,colSize) && maze[i][j] == '.'){ //Posible Component
                ...
                //    littersOfPaint = littersOfPaint + 1; ///****///
                    ...
                    do{ //Find Walls for painting
                        ...
                        for(int aux = 0; aux < 4 ; aux++){
                            ...
                            if(ok(nbr.row,nbr.col,rowSize,colSize) && maze[ nbr.row ][ nbr.col ] == '#' ){
